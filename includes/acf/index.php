<?php
// require_once get_stylesheet_directory() . '/includes/acf/post-types/brand.php';
// require_once get_stylesheet_directory() . '/includes/acf/post-types/product.php';

// require_once get_stylesheet_directory() . '/includes/acf/taxonomies/collections.php';
// require_once get_stylesheet_directory() . '/includes/acf/taxonomies/colors.php';
