<form role="search" method="get" class="search-form" action="<?php echo home_url('/'); ?>">
  <div class="relative w-full search-input-group">
    <input type="search" id="search" class="search-field" placeholder="<?php echo esc_html__('Search our products and brands...', 'my-theme-child'); ?>" value="<?php echo get_search_query(); ?>" name="s" />
